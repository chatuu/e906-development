...
cuts_dict = {
    ...
    "z1_v and z2_v within -320 to -5": "z1_v > -320 and z1_v < -5 and z2_v > -320 and z2_v < -5",
    "xt^2 + (yt - beamOffset)^2 < 320": "((x1_t**2 + (y1_t - beamOffset)**2 < 320)) and ((x2_t**2 + (y2_t - beamOffset)**2 < 320))",
...
variables_list = [
    ...
    "trackSeparation",
    "x1_t", "x2_t", "y1_t", "y2_t", "z1_v", "z2_v",
    "x1_st1", "x2_st1", "y1_st1", "y2_st1", "y1_st3", "y2_st3",
    "py1_st1", "py2_st1", "pz1_st1", "pz2_st1",
