...
def main():
    ...
    with Progress(
        ...
        # Stage 4: Cross Sections & Ratios (Calculates for both geometric & true pT & pT2 centroids)
    ...
    # 3. Finalize
    analyzer.finalize()
    console.print("\n[bold green]✔ All histograms, tables, single differential cross-section plots (geom & true for pT and pT²), ratio plots, and overlays generated successfully.[/bold green]")
