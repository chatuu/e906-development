...
def print_physics_constants():
    ...
    table.add_row("Global Constant LH2 (w/o width)", f"{GLOBAL_CONSTANT_LH2:.4e}")
    table.add_row("Global Constant LD2 (w/o width)", f"{GLOBAL_CONSTANT_LD2:.4e}")
