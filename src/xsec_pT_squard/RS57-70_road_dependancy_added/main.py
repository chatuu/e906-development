...
def main():
    ...
    with Progress(
        ...
        analyzer = DYCrossSectionAnalyzer(
            ...
            out_filename="All_XSec_Objects_pT2.root"
        )
        ...
        # Stage 3: Subtractions (Implicitly handled inside calculate_cross_sections)
    ...
    # 3. Finalize
    analyzer.finalize()
    console.print("\n[bold green]✔ All histograms, tables, single differential cross-section plots (geom & true pT²), ratio plots, and overlays generated successfully.[/bold green]")
