...
class DYCrossSectionAnalyzer:
    ...
    def apply_cuts(tree, cut=4.2):
        ...
        total_cut_mask = (track1_cut & track2_cut & tracks_cut & dimuon_cut & occ_cut & xF_cut & mass_cut)
    ...
    def calculate_and_plot_cross_section(self, h_sub_dict, target_label, global_constant, use_true_pt=False):
        ...
        acc_path = "/root/github/e906-development/src/AcceptanceCorrection/NoD1Cut/acceptance_mass_xF.root"
