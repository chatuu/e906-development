...
def main():
    ...
    analyzer = DYCrossSectionAnalyzer(
        lh2_file="../../HodoEfficiency/RS57-70/RS62/merged_RS62_LH2_recoeff_hodoeff.root",
        ld2_file="../../HodoEfficiency/RS57-70/RS62/merged_RS62_LD2_recoeff_hodoeff.root",
        flask_file="../../HodoEfficiency/RS57-70/RS62/merged_RS62_Flask_recoeff_hodoeff.root",
