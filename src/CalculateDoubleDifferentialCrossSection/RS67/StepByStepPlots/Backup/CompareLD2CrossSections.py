    ...
    for i_x in range(n_xf_bins):
                ...
                for row in SHIVANGI_DATA[xf_key]:
                    ...
                    if abs(row[0] - mass_min) < 0.01 and abs(row[1] - mass_max) < 0.01:
                        ...
                        if shiv_xsec != 0.0:
                            ...
                            g_sys_shivangi.SetPointError(point_idx_shivangi, mass_width/2.0, shiv_sys)
        ...
        if g_xsec.GetN() > 0 or g_xsec_shivangi.GetN() > 0:
            ...
            if target_label == "LD2" and g_xsec_shivangi.GetN() > 0:
                ...
                g_sys_shivangi.SetFillColorAlpha(ROOT.kAzure - 9, 0.5)
                g_sys_shivangi.SetFillStyle(1001)
                mg.Add(g_sys_shivangi, "2")
                ...
                leg.AddEntry(g_sys_shivangi, "Shivangi Syst.", "f")
            ...
            if g_xsec.GetN() > 0:
                ...
                leg.AddEntry(g_sys, "Current Syst.", "f")
