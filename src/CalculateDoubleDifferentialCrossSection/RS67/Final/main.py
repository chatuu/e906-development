...
def main():
    ...
    analyzer = DYCrossSectionAnalyzer(
        lh2_file="../../../HodoEfficiency/RS67/AllTargets/merged_RS67_3089_LH2_recoeff_hodoeff.root",
        ld2_file="../../../HodoEfficiency/RS67/AllTargets/merged_RS67_3089_LD2_recoeff_hodoeff.root",
        flask_file="../../../HodoEfficiency/RS67/AllTargets/merged_RS67_3089_Flask_recoeff_hodoeff.root",
