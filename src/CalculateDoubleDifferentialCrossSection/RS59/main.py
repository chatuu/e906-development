...
def main():
    ...
    analyzer = DYCrossSectionAnalyzer(
        lh2_file="../../HodoEfficiency/RS57-70/RS59/merged_RS59_LH2_recoeff_hodoeff.root",
        ld2_file="../../HodoEfficiency/RS57-70/RS59/merged_RS59_LD2_recoeff_hodoeff.root",
        flask_file="../../HodoEfficiency/RS57-70/RS59/merged_RS59_Flask_recoeff_hodoeff.root",
