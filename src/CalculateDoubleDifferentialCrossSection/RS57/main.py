...
def main():
    ...
    analyzer = DYCrossSectionAnalyzer(
        lh2_file="../../HodoEfficiency/RS57-70/RS57/merged_RS57_LH2_recoeff_hodoeff.root",
        ld2_file="../../HodoEfficiency/RS57-70/RS57/merged_RS57_LD2_recoeff_hodoeff.root",
        flask_file="../../HodoEfficiency/RS57-70/RS57/merged_RS57_Flask_recoeff_hodoeff.root",
