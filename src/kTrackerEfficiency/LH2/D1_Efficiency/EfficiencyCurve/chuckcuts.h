...
TCut chuckCutsPositive_2111v37 = TString::Format("chisq1_target < 14 && pz1_st1 > 9 && pz1_st1 < 75 && nHits1 > 13 && x1_t*x1_t + (y1_t-%f)*(y1_t-%f) < 320 && x1_d*x1_d + (y1_d-%f)*(y1_d-%f) < 1100 && x1_d*x1_d + (y1_d-%f)*(y1_d-%f) > 16 && chisq1_target < 1.5* chisq1_upstream && chisq1_target < 1.5*chisq1_dump && z1_v < -5 && z1_v > -320 && chisq1/(nHits1-5) < 12 && atan(y1_st3/y1_st1) > 0.7 && abs(px1_st1-px1_st3+0.416) < 0.008 && abs(py1_st1-py1_st3) < 0.008 && abs(pz1_st1-pz1_st3) < 0.08 && y1_st1*y1_st3 > 0 && abs(posRoad) < 55000", beamOffset,beamOffset,beamOffset,beamOffset,beamOffset,beamOffset).Data();

TCut chuckCutsNegative_2111v37 = TString::Format("chisq2_target < 14 && pz2_st1 > 9 && pz2_st1 < 75 && nHits2 > 13 && x2_t*x2_t + (y2_t-%f)*(y2_t-%f) < 320 && x2_d*x2_d + (y2_d-%f)*(y2_d-%f) < 1100 && x2_d*x2_d + (y2_d-%f)*(y2_d-%f) > 16 && chisq2_target < 1.5* chisq2_upstream && chisq2_target < 1.5*chisq2_dump && z2_v < -5 && z2_v > -320 && chisq2/(nHits2-5) < 12 && atan(y2_st3/y2_st1) > 0.7 && abs(px2_st1-px2_st3-0.416) < 0.008 && abs(py2_st1-py2_st3) < 0.008 && abs(pz2_st1-pz2_st3) < 0.08 && y2_st1*y2_st3 > 0",beamOffset,beamOffset, beamOffset,beamOffset,beamOffset,beamOffset).Data();

TCut chuckCutsDimuon_2111v37 = TString::Format("abs(dx) < 0.25 && abs(dy-%f)< 0.22 && dz > -280 && dz < -5 && abs(dpx) < 1.8 && abs(dpy) < 2 && dpx*dpx + dpy*  dpy < 5 && dpz > 38 && dpz < 116 && dx*dx + (dy-%f)*(dy-%f) < 0.08 && abs(trackSeparation) < 270 && chisq_dimuon < 17 && abs(chisq1_target+ chisq2_target-chisq_dimuon) < 2 && y1_st3*y2_st3 < 0 && nHits1 + nHits2 > 29 &&  nHits1St1 + nHits2St1 > 8 && min(pz1_st1,pz2_st1) - max(x1_st1,-x2_st1)/4.5 > 12  && min(abs(py1_st1),abs(py2_st1)) > 0.05",beamOffset,beamOffset,beamOffset).Data();      

TCut physicsCuts_2111v37 = "mass > 4.2 && mass < 8.8 && xF < 0.95 && xF > -0.1 && xT > 0.05 && xT < 0.5 && abs(costh) < 0.5";                                  

TCut physicsCuts_noxT_2111v37 = "mass > 4.2 && mass < 8.8 && xF < 0.95 && xF > -0.1 && abs(costh) < 0.5";                                  

TCut physicsCuts_noMassCut_2111v37 = "xF < 0.95 && xF > -0.1 && xT > 0.05 && xT < 0.5 && abs(costh) < 0.5";                                  

TCut occCuts_2111v37 = "D1 < 400 && D2 < 400 && D3 < 400";
...
TCut DYCut_MC ="0.99*mass>4.2 && 0.99*mass<8.8 &&xB<0.8";
//TCut DYCut_MC ="mass>4.2 && mass<8.8";
