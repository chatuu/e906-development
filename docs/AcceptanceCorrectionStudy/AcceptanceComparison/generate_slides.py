...
def main():
    ...
    # Define paths for the existing (left), latest (right) plots, and comparisons
    # os.path.expanduser expands '~' to the full home directory path for LaTeX compatibility
...
"""
    ...
    latex_content += make_frame_2cols("Existing (Left) vs Latest (Right): Mass (Integrated)", 
                                      f"{OLD_DIR}/acceptance_overlay_Integrated_mass.pdf", 
                                      f"{NEW_DIR}/acceptance_overlay_Integrated_mass.pdf")
    
    latex_content += make_frame_2cols("Existing (Left) vs Latest (Right): Mass Acceptance (All $x_F$, $p_T$)", 
                                      f"{OLD_DIR}/Acceptance_Mass_All_xF_pT.pdf", 
                                      f"{NEW_DIR}/Acceptance_Mass_All_xF_pT.pdf")
    
    latex_content += make_frame_2cols("LH2 (Left) vs LD2 (Right): Latest/Existing Mass Acc.", 
    ...
    latex_content += make_frame_2cols("Existing (Left) vs Latest (Right): $x_F$ (Integrated)", 
                                      f"{OLD_DIR}/acceptance_overlay_Integrated_xF.pdf", 
                                      f"{NEW_DIR}/acceptance_overlay_Integrated_xF.pdf")
    
    latex_content += make_frame_2cols("Existing (Left) vs Latest (Right): $x_F$ Acceptance (All Mass, $p_T$)", 
                                      f"{OLD_DIR}/Acceptance_xF_All_Mass_pT.pdf", 
                                      f"{NEW_DIR}/Acceptance_xF_All_Mass_pT.pdf")

    latex_content += make_frame_2cols("LH2 (Left) vs LD2 (Right): Latest/Existing $x_F$ Acc.", 
    ...
    latex_content += make_frame_2cols("Existing (Left) vs Latest (Right): $p_T$ (Integrated)", 
                                      f"{OLD_DIR}/acceptance_overlay_Integrated_pT.pdf", 
                                      f"{NEW_DIR}/acceptance_overlay_Integrated_pT.pdf")
    
    latex_content += make_frame_2cols("Existing (Left) vs Latest (Right): $p_T$ Acceptance (All Mass, $x_F$)", 
                                      f"{OLD_DIR}/Acceptance_pT_All_Mass_xF.pdf", 
                                      f"{NEW_DIR}/Acceptance_pT_All_Mass_xF.pdf")
                                      
    latex_content += make_frame_2cols("LH2 (Left) vs LD2 (Right): Latest/Existing $p_T$ Acc.", 
    ...
    # ==========================================
    latex_content += r"\section{Mass Sliced by $x_F$ Overlays}" + "\n"
    ...
    for i in range(16):
        ...
        # 1. Overlay Slide
        title_overlay = f"Existing vs Latest: Mass Overlay ({bin_label})"
        ...
        title_acc = f"Existing vs Latest: Mass Acceptance ({bin_label})"
        ...
        title_comp = f"LH2 (L) vs LD2 (R): Latest/Existing Mass Acc. ({bin_label})"
