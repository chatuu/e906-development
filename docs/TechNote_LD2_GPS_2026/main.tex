...
\begin{itemize}
    ...
    \item $\langle\epsilon^{\text{LH2}}_{\text{signal}}\rangle$ is the average signal efficiency correction for the LH2 target dimuons.
    \item $\langle\epsilon^{\text{flask}}_{\text{signal}}\rangle$ is the average signal efficiency correction for the flask target dimuons.
    \item $\mathcal{L}$ is the integrated luminosity for the dataset.
\end{itemize}
The average signal efficiency correction can be calculated as:
\begin{equation}
    \langle\epsilon_{\text{signal}}\rangle = \frac{1}{Y_{\text{total}} - Y_{\text{mixed}}}\left[\langle\epsilon_{\text{total}}\rangleY_{\text{total}} - \langle\epsilon_{\text{mixed}}\rangleY_{\text{mixed}}\right]
\end{equation}
where:
\begin{itemize}
    \item $\langle\epsilon_{\text{total}}\rangle$ is the average total efficiency correction for the total yield.
    \item $\langle\epsilon_{\text{mixed}}\rangle$ is the average mixed efficiency correction for the mixed background yield.
\end{itemize}
...
The calculation of these efficiency corrections is detailed in the following sections.
...
Also, $\epsilon_{\text{acc}}$ is the geometric and kinematic acceptance of the spectrometer.
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{/root/github/e906-development/docs/TechNote_LD2_GPS_2026/HodoEffDists/E_mix_hodo_LD2.pdf}
...
The total efficiency correction $\epsilon^{i}_{\text{total}}$ for the $i^{th}$ is calculated on a dimuon-by-dimuon basis as the product of the reconstruction and hodoscope efficiencies as defined in the equation \ref{eq:total_eff}.
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{/root/github/e906-development/docs/TechNote_LD2_GPS_2026/FinalEffDists/E_mix_final_LD2.pdf}
