...
path_rs57_70 = "/root/github/e906-development/src/CalculateDoubleDifferentialCrossSection/RS57-70/"
...
latex = [
    ...
    r"\title{Comparison Between RS67 Vs RS57-70}",
...
for plot in filtered_plots:
    ...
    latex.append(r"\column{0.5\textwidth}\centering \textbf{RS57-70} \\ \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{" + path_rs57_70 + plot + "}")
