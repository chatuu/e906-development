...
\setbeamertemplate{footline}{
  ...
  \begin{beamercolorbox}[wd=.333333\paperwidth,ht=2.25ex,dp=1ex,center]{author in head/foot}%
    \usebeamerfont{author in head/foot}Chatura Kuruppu (SeaQuest Experiment)
  \end{beamercolorbox}%
  \begin{beamercolorbox}[wd=.333333\paperwidth,ht=2.25ex,dp=1ex,center]{title in head/foot}%
    \usebeamerfont{title in head/foot}Single Differential Cross-Section in $p_{T}$ bins
  \end{beamercolorbox}%
  \begin{beamercolorbox}[wd=.333333\paperwidth,ht=2.25ex,dp=1ex,left]{date in head/foot}%
    \usebeamerfont{date in head/foot}\hspace*{\fill}2026-05-13\hspace*{\fill}\rlap{\insertframenumber{}/\inserttotalframenumber}\hspace*{2ex}
  \end{beamercolorbox}}%
  \vskip0pt%
}

\graphicspath{{/root/github/e906-development/src/xsec_pT/RS57-70/}{/root/github/e906-development/src/CalculateDoubleDifferentialCrossSection/RS57-70/}{/root/github/e906-development/src/AcceptanceCorrection/}}

\title{Measurement of Absolute Single Differential Cross-Section in $p_T$ Bins using Runs 2 and 3 Data}
