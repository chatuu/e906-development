...
path_rs57_70 = "/root/github/e906-development/src/CalculateDoubleDifferentialCrossSection/RS62/"
...
latex = [
    ...
    r"\title{Comparison Between RS67 Vs RS62}",
...
for plot in filtered_plots:
    ...
    latex.append(r"\column{0.5\textwidth}\centering \textbf{RS62} \\ \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{" + path_rs57_70 + plot + "}")
