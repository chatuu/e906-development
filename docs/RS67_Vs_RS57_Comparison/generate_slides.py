...
path_rs57_70 = "/root/github/e906-development/src/CalculateDoubleDifferentialCrossSection/RS57/"
...
latex = [
    ...
    r"\title{Comparison Between RS67 Vs RS57}",
...
for plot in filtered_plots:
    ...
    latex.append(r"\column{0.5\textwidth}\centering \textbf{RS57} \\ \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{" + path_rs57_70 + plot + "}")
